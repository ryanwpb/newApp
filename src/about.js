      ...
      <section id="about">
        ...
        <div className="col">
          <div className="col col-left">
           <p className="p1"><span className="s1">Hello. I’m Ryan Graham. I’m a Web Developer. I come up with ideas & concepts that help you drive business. I’ve been in the business for over 3 years and can tackle everything from single page web applications to new site builds. I adapt my style to suit every job and have worked with some really amazing companies.</span></p>
         </div>
